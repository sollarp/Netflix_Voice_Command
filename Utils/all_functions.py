...
import tkinter
import os
from Support.text_to_speech_goog_ai import speech_result_return
import pygame
...
class FunctionSupport:
    ...
    def searching_in_searchBar(self, text_q, last_word):  ## Netflix search bar function
        ...
        ##  find URL and Movie title on netflix website
    def find_elements_on_website(self, f_loop):
        ii = None
        for ii in range(0, 5):
        ...
        ## Selenium webdriver session to reuse opened webdriver
