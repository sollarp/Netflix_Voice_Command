...
class GoogleSearch:
    ...
    def init_chrome_options(self):
        ...
        self.chrome_options.add_argument("--user-agent=Mozilla/5.0 (X11; CrOS armv7l 11895.95.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.125 Safari/537.36"
)
                    ...
                    if local_database == 'not_in_database':
                        ...
                        if return_sql_url == '0':
                            ...
                            if x:
                                self.driver.get(url_link)
                                time.sleep(1)
                                self.searching_in_searchBar(text_q, last_word) #searching in netflix website search bar
